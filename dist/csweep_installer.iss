...
SetupIconFile=icon_glow.ico   ; <- ✅ Installer window icon

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Files]
Source: "dist\csweep.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Name: "{commondesktop}\CyberSweep"; Filename: "{app}\csweep.exe"; Tasks: desktopicon; IconFilename: "{app}\csweep_icon_glow.ico"
